  ...
  return (
    <>
      <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-32 backdrop-blur">
        ...
        <button className="md:hidden text-[25px]" onClick={() => setOpen(true)}>
          <RxHamburgerMenu />
        </button>
      </nav>

      {open && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur flex flex-col items-center justify-center gap-6 text-lg">
